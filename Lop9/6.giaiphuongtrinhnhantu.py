...
cau_hoi_mot = beginex() + "Giải phương trình:\n"
...
for i in range(1,so_cau+1):
    ...
    cau_hoi_mot = cau_hoi_mot + "\\item" + " $" + ham_nhan_tu_hdt_so_ba(a,b) + "=0$\n"
...
for i in range(1,so_cau+1):
    a = random.choice(range(1,100))
    b = random.choice(range(1,100))
    while kt_cp(a) == False or kt_cp(b) ==False:
        a = random.choice(range(1,100))
        b = random.choice(range(1,100))
    cau_hoi_mot = cau_hoi_mot + "\\item " + "$" + ham_nhan_tu_hdt_so_ba_nguoc(a,b) + "=0$\n"
cau_hoi_mot = cau_hoi_mot + itemize_e() + endex()
print(cau_hoi_mot)
...
for i in range(1,so_cau+1):
    ...
    while kt_cp(b) == True:
        b = random.choice(range(1,30))
    cau_hoi_mot = cau_hoi_mot + "\\item " + "$" + ham_nhan_tu_hdt_so_mot(b) + "=0$\n"
cau_hoi_mot = cau_hoi_mot + itemize_e() + endex()
print(cau_hoi_mot)
...
for i in range(1,so_cau+1):
    ...
    while kt_cp(b) == True:
        b = random.choice(range(1,30))
    cau_hoi_mot = cau_hoi_mot + "\\item " + "$" + ham_nhan_tu_hdt_so_hai(b) + "=0$\n"
cau_hoi_mot = cau_hoi_mot + itemize_e() + endex()
print(cau_hoi_mot)